...
export default class extends Controller {
  static targets = ["name", "address", "activity", "chiffreAffaires", "croissanceChiffreAffaires", "margeBrute", "tauxMargeBrute", "excedentBrutExploitation", "tauxMargeEbitda", "apiData"]
  ...
  autocomplete(e){
    if (e.target.value.length === 14) {
      fetch(`https://api.pappers.fr/v1/entreprise?siret=${e.target.value}&api_token=0c665a6e4a30a3f1cb26ce756a2bb42eec327381493a9373`)
